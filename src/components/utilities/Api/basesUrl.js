...
export const URL_AUTH = axios.create({
  ...
  // Como default o axios só vem configurado para tratar responses de maior que 200 e até 300
  // Então foi definido para tratamentos de status nessa rota de até 404
